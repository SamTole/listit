...
const SideMenu = () => {
  ...
  return (
    <div className='bg-white flex justify-between items-center px-12 py-4 shadow-md'>
      <Logo />
      <div className='flex items-center'>
          ...
          <Link to={'/calendar'}><FontAwesomeIcon icon={faCalendar} size='xl' className={`${location.pathname == '/calendar' ? 'text-light-purple-1' : 'text-gray-4'} transition hover:text-light-purple-1`} /></Link>
          ...
          <Link to={'/profile'} className='flex items-center text-gray-4'>
            <FontAwesomeIcon icon={faUserCircle} size='2xl' className={`${location.pathname == '/profile' ? 'text-light-purple-1' : 'text-gray-4'} mr-2 transition hover:text-light-purple-1`} />
